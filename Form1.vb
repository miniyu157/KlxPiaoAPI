    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        For Each c In Panel1.Controls
            If TypeOf c Is KlxPiaoPanel Then
                AddHandler DirectCast(c, KlxPiaoPanel).Click, AddressOf 颜色展示Panel点击
            End If
        Next

        '给KlxPiaoAPI函数.控件添加点击事件
        For Each c In TabPage8.Controls
            If TypeOf c Is KlxPiaoPanel Then
                AddHandler DirectCast(c, KlxPiaoPanel).Click, AddressOf Panel展示点击
            End If
        Next
    End Sub
    '大小适应
...
#Region "Panel展示"
    Private Sub Panel展示点击(sender As Object, e As EventArgs)
        Dim panel As KlxPiaoPanel = DirectCast(sender, KlxPiaoPanel)
...
#Region "颜色"
    Private Sub 颜色亮度TrackBar_值Changed(sender As Object, e As System.ComponentModel.PropertyChangedEventArgs) Handles 颜色亮度TrackBar.值Changed
        ...
        Next
    End Sub
    Private Sub 颜色展示Panel点击(sender As Object, e As EventArgs)

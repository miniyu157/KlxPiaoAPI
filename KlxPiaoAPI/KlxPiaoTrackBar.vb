...
Public Class KlxPiaoTrackBar
    ...
    Private _值 As Single
    Private _最大值 As Single
    Private _最小值 As Single
    Private _鼠标滚轮响应方式 As 鼠标滚轮响应
    Private _键盘响应方式 As 键盘响应
    Private _增减大小 As Single
    Private _保留小数位数 As Integer
    Public Sub New()
        MyBase.New()
    ...
    <DefaultValue(1)>
    Public Property 增减大小 As Single
        Get
            Return _增减大小
        End Get
        Set(value As Single)
    ...
    <DefaultValue(0)>
    Public Property 保留小数位数 As Integer
        Get
            Return _保留小数位数
        End Get
        Set(value As Integer)
...
#Region "鼠标调整值"
    ...
    Protected Overrides Sub OnMouseDown(e As MouseEventArgs)
        ...
        If e.Button = MouseButtons.Left Then
            ...
            值 = Math.Round(最小值 + 绘制百分比 * (最大值 - 最小值), 保留小数位数)
        End If

...
Public Class KlxPiaoForm
    ...
    <Category("窗体按钮"), Description("关闭按钮的前景色")>
    Public Property 关闭按钮前景色 As Color
        ...
        End Set
    End Property
    <Category("窗体按钮"), Description("关闭按钮的背景色")>
    Public Property 关闭按钮背景色 As Color
        ...
        End Set
    End Property
    <Category("窗体按钮"), Description("关闭按钮鼠标移入的背景色")>
    Public Property 关闭按钮鼠标移入背景色 As Color
        ...
        End Set
    End Property
    <Category("窗体按钮"), Description("关闭按钮鼠标按下的背景色")>
    Public Property 关闭按钮鼠标按下背景色 As Color
        ...
        End Set
    End Property
    <Category("窗体按钮"), Description("最小化按钮的前景色")>
    Public Property 最小化按钮前景色 As Color
        ...
        End Set
    End Property
    <Category("窗体按钮"), Description("最小化按钮的背景色")>
    Public Property 最小化按钮背景色 As Color
        ...
        End Set
    End Property
    <Category("窗体按钮"), Description("最小化按钮鼠标移入的背景色")>
    Public Property 最小化按钮鼠标移入背景色 As Color
        ...
        End Set
    End Property
    <Category("窗体按钮"), Description("最小化按钮鼠标按下的背景色")>
    Public Property 最小化按钮鼠标按下背景色 As Color
        ...
        End Set
    End Property
    <Category("窗体按钮"), Description("缩放按钮的前景色")>
    Public Property 缩放按钮前景色 As Color
        ...
        End Set
    End Property
    <Category("窗体按钮"), Description("缩放按钮的背景色")>
    Public Property 缩放按钮背景色 As Color
        ...
        End Set
    End Property
    <Category("窗体按钮"), Description("缩放按钮鼠标移入的背景色")>
    Public Property 缩放按钮鼠标移入背景色 As Color
        ...
        End Set
    End Property
    <Category("窗体按钮"), Description("缩放按钮鼠标按下的背景色")>
...
#End Region
    ...
    Public Function 获取工作区矩形() As Rectangle
        Return New Rectangle(0, 标题框高度, Width, Height - 标题框高度)
    End Function
    Public Function 获取工作区大小() As Size
        Return New Size(Width, Height - 标题框高度)
    End Function

    Public Sub 显示提示框(内容 As String, 标题 As String)
